...
fn swapp_note_full_fill_transfers_assets() {
    ...
    expect!["11982"].assert_eq(single_note_cycles(executed_tx.measurements()));
...
fn swapp_note_partial_fill_creates_remainder_and_chains() {
    ...
    expect!["16884"].assert_eq(single_note_cycles(executed_tx.measurements()));
...
fn swapp_note_creator_reclaims_offered_asset() {
    ...
    expect!["5056"].assert_eq(single_note_cycles(executed_tx.measurements()));
